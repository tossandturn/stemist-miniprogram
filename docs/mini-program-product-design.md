...
- 按新增需求，首页保留六个独立入口：A-Level、IELTS、AP、IB、竞赛、计算器，以及右上角 AI Coach。AP / IB 不进入剑桥题库路由；目录、文件下载和逐题练习的可用状态分开。
...
小程序是统一产品的轻量入口，首页展示六个一级入口：

`A-Level 学科 | IELTS | AP | IB | 竞赛 / 入学考试 | Casio 计算器`
...
2. 六张入口卡：A-Level 学科、IELTS、AP、IB、竞赛/入学考试、Casio 计算器；不在首页平铺二级功能。
...
- 底部固定五项导航：Today / Practice / AI Coach / Progress / Account；首页本身展示六个一级入口，不增加底部导航项。
