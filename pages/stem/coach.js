...
Page({
  data: deviceState({ imagePath: '', message: '', loading: false, error: '', answer: '' }),
  onLoad(options) {
  ...
  async ask() {
    ...
    try {
      ...
      const result = await askCoach({
        ...
        context: { product: 'STEM Studio', mode: 'photo-question', stage: 'practice', source: 'stemist-miniprogram' },
      })
