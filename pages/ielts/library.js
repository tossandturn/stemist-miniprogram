...
Page({
 ...
 onLoad(options={}){this.__disposed=false;this.__generation=0;const module=TITLES[options.module]?options.module:'listening';this.setData({module,title:TITLES[module],...(module==='writing'?{scopes:[{id:'paper',label:'单题'},{id:'pair',label:'完整写作'},{id:'topic',label:'主题'}]}:module==='speaking'?{scope:'topic',scopes:[{id:'topic',label:'主题'},{id:'paper',label:'整套'}]}:{})});this.load()},
