...
const remote = module.exports.remoteLearningRecords([{ attemptId: 'remote-1', mode: 'topic', routeId: 'cie-9702-as-physics', stage: 'AS', submittedAt: new Date(now).toISOString(), attempt: { category: 'alevel', family: 'exam', markingMode: 'ai-coach-photo' } }])
...
assert.equal(merged[0].category, 'alevel')
