...
function completeExamModule(key,module,value){const exam=readExam(key);if(!exam||exam.submitted)throw new Error('模拟已结束或账号已变化。');exam.modules[module]=value;saveExam(exam);return exam}
...
module.exports={PREFIX,completeSets,examChoices,newExam,saveExam,readExam,completeExamModule,submitExam}
